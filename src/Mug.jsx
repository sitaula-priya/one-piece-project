...
import web1 from "../src/images/cp6.jfif";
import web2 from "../src/images/cp3.jpg";
import web3 from "../src/images/cp5.jpg";
import web4 from "../src/images/cp6.jfif";
...
class Mug extends Component {
    ...
    render() { 
        ...
        <div className="my-5">
            <h1 className="text-center">Our Mugs</h1>
        </div>
        ...
        <p className="card-text"> Pork belly, which comes from the side of the hog, is called bacon once it has been cured and smoked. </p>
         ...
         <div className="col-md-4 col-10 mx-auto">
         <div className="card" >
         <img src={web2} className="card-img-top" alt="op.jpg"/>
         <div className="card-body">
         <h5 className="card-title">Mug</h5>
        ...
        <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
         ...
         <div className="col-md-4 col-10 mx-auto">
         <div className="card" >
         <img src={web4} className="card-img-top" alt="zoro.jpg"/>
         <div className="card-body">
         <h5 className="card-title">Mug</h5>
        <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
         <NavLink to="/contact" className="btn btn-primary">Contact us</NavLink>
