...
import web1 from "../src/images/t1.webp";
import web3 from "../src/images/t3.webp";
import web4 from "../src/images/t4.webp";
...
class Tshirt extends Component {
    ...
    render() { 
        ...
        <div className="my-5">
            <h1 className="text-center">Our Tshirt Products</h1>
        </div>
